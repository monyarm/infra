...
# Usage: prefetchSteamCdnImages --appId <appid> [--output-file <file>]
#
# Prefetches a game's Steam library artwork (hero/grid/wide/logo) via
# lib/fetchers.nix's fetchSteamCdnImages and prints the resulting hash
# (a single fixed-output hash for the whole image bundle).
