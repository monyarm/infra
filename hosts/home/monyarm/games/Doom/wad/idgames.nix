...
lib.mkIf config.games.doom.enable {
  games.doom.wads = {
    paranoid =
      fetchIdGames sources.wad.paranoid |> getFile "Paranoid.pk3" |> optimizePk3;
    paranoiac =
      fetchIdGames sources.wad.paranoic |> getFile "paranoic.pk3" |> optimizePk3;
    ...
    inquisitor3Res =
      fetchIdGames sources.wad.inquisitor3
      |> getFile "inq3resE.pk3"
      |> optimizePk3;
