...
with image;
{
  ...
  assassinsCreedChroniclesIndia = fetchSteamCards {
    appId = 359610;
    hash = "sha256-dch/P92iiAyDRipsXd3YN99A5hetXUP0y7nm0ju6zAk=";
  };
  assassinsCreedChroniclesChina = fetchSteamCards {
    appId = 354380;
    hash = "sha256-7VWwuAQAweOwZeRV7GsJ30mygfPHjik8Dw4qHceeY0I=";
  };
  assassinsCreedChroniclesRussia = fetchSteamCards {
    appId = 359600;
    hash = "sha256-+k5nTdpC8SkiqwVvWk1sr0klJvadhocfeyErtq4old8=";
  };
  ...
  acLiberationFanKit = fetchzipSelective {
  ...
  acUnityFanKit = fetchzipSelective {
