...
from future.builtins import (ascii, bytes, chr, dict, filter, hex, input, int,
                             list, map, next, object, oct, open, pow, range,
                             round, str, super, zip)
...
if _gimp_dependent_modules_imported:
  ...
  from . import (fileformats, gui, invocation, invoker, itemtree, objectfilter,
                 overwrite, path, pdbutils, progress, setting)
  from .setting import SettingGuiTypes, SettingTypes
