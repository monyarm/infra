{ lib, dirs, ... }:
let
  doomConf = lib.generators.toINI { listsAsDuplicateKeys = true; } {
    # This file was generated by GZDoom <unknown version> on 2023-07-12 14:39:41
    ...
    "SoundfontSearch.Directories" = {
      Path = [
        "${dirs.HOME}/.config/gzdoom/soundfonts"
        "${dirs.HOME}/.config/gzdoom/fm_banks"
        "/usr/share/gzdoom/soundfonts"
        "/usr/share/gzdoom/fm_banks"
    ...
    "Doom.AutoExec" = {
      Path = "${dirs.HOME}/.config/gzdoom/autoexec.cfg";
    };
    ...
    # (the game) and files that only load for particular IWADs. For example,
...
in
{
  xdg.configFile."zdoom/zdoom.ini".text = doomConf;
  xdg.configFile."gzdoom/gzdoom.ini".text = doomConf;
  xdg.configFile."uzdoom/uzdoom.ini".text = doomConf;
}
